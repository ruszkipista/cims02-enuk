...
<details>
<summary>A state <a id="A">BeforePhase1</a> (generate game area for Phase 1)</summary>
...
<details>
<summary>B state <a id="B">InPhase1-BeforeMove</a> (prepare actual player’s move)</summary>
...
<details>
<summary>C state <a id="C">InPhase1-ProcessMove</a> (collecting tiles and building the igloo)</summary>
...
<details>
<summary>D state <a id="D">InPhase1-Evaluation</a> (evaluate game state after move)</summary>
...
<details>
<summary>E state <a id="E">InPhase1-Execution</a> (execute actions based on evaluation)</summary>
...
<details>
<summary>F state <a id="F">BeforePhase2</a> (set up board for Phase 2)</summary>
...
<details>
<summary>G state <a id="G">InPhase2-CollectOneIgloo</a> (collect one tile from the igloo)</summary>
...
<details>
<summary>H state <a id="H">InPhase2-BeforeDeclaration</a></summary>
...
<details>
<summary>I state <a id="I">InPhase2-BeforeMove</a></summary>
...
<details>
<summary>J state <a id="J">InPhase2-ProcessMove</a></summary>
...
<details>
<summary>K state <a id="K">InPhase2-Evaluation</a> (evaluate game state after move)</summary>
...
<details>
<summary>L state <a id="L">InPhase2-Execution</a> (execute actions based on evaluation)</summary>
...
<details>
<summary>M state <a id="M">EndOfGame</a></summary>
...
<details>
<summary>N state <a id="N">EndOfGame-ProcessMove</a></summary>
